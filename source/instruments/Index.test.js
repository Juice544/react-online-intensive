...
describe('instruments:', () => {
    ...
    test('getFullApiUrl function should produce a string of a desired given length', () => {
        expect(typeof getFullApiUrl('131', '344')).toBe('string');
    });
    test('getFullApiUrl function should throw, when called with non-string type of both arguments', () => {
        expect(() => getFullApiUrl(5, true)).toThrow();
    });
});
